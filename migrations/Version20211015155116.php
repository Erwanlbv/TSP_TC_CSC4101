 ...
 */
final class Version20211015155116 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , password VARCHAR(255) NOT NULL COLLATE BINARY, is_verified BOOLEAN NOT NULL, CONSTRAINT FK_8D93D6497E3C61F9 FOREIGN KEY (owner_id) REFERENCES owner (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
